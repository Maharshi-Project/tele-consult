    ...
    <div>
      ...
      <div className={`sidenav ${isOpen ? 'open' : ''}`}>
        <ul id='sidenavitem'>
          ...
          <li className={location.pathname === '/' ? 'active' : ''}><Link to="/"> Home<i className="fas fa-home"></i></Link> </li>
          {/* Add 'active' class to the <li> if the current location matches */}
          ...
          <li className={location.pathname === '/patienthistory' ? 'active' : ''}><Link to="/">Patient History<i className="fas fa-history"></i></Link></li>
